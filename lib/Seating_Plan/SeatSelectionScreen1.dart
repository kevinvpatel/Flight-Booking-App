...
class Seatselectionscreen1 extends StatefulWidget {

  final String fligh_id;
  final String user_id;
  final String fligh_name;
  Seatselectionscreen1({required this.fligh_id, required this.user_id, required this.fligh_name, super.key});

  @override
  State<Seatselectionscreen1> createState() => _Seatselectionscreen1State();
}

class _Seatselectionscreen1State extends State<Seatselectionscreen1> {
